...
<a href="/driver/dashboard" className="logo">
...
{maintenanceDropdown && (
 <>
<li>
 <Link to="/driver/deliveries"  id='subMenu'>
 Delivery List
 </Link> 
</li >
</>
...
</li>
{
 fuel && (
   <>
   <li>
     <Link to="/driver/fuel/manage"  id='subMenu'>
     Fuel Management
     </Link> 
   </li >
   <li >
   <Link to="/driver/fuel/add" id='subMenu'>
   Add Fuel
   </Link> 
 </li>
 </>
...
{trackingDropdown && (
 <>
<li >
<a href="/driver/history" id='subMenu'>
Deliveries
</a> 
</li>
</>
...
<Link to="/driver/settings" className="profile">
